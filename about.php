...
<head>
    ...
    <title>Nanette's Cake - About Us</title>
    <!-- Bootstrap CSS -->
        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">Nanette's Cake</a>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="uploads/logo.jpg" alt="" class="user-avatar-md rounded-circle"></a>
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="admin/index.php"><i class="fas fa-sign-in-alt mr-2"></i>Login</a>
                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			<div class="text-secondary font-italic m-3">
                                    ...
                                    <p>
                                        Our online store is a leading online shop in Gensan providing cakes and gifts deliveries within Gensan. We provide competitive prices, good after sales services and on-time delivery.
                                    </p>
                                    <p>
                                        The Cake Shop provides same day delivery service seven days a week, including Sunday, within Gensan to provide a high level of customer service.
                                    </p>
                                    <p>
                                        Bon Appetite!!
                                    </p>
                            ...
                            <div class="item">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <a href="shop.php?category=<?php echo $res['category_id'];?>"><img class="card-img" src="uploads/categories/<?php echo $res['category_image'];?>"></a>
                                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2023 Concept. All rights reserved. Dashboard by <a href="https://web.facebook.com/NanetteCakeCreation">Nanette's Cake</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
