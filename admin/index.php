...
<head>
    ...
    <title>Nanette's Cake - Login</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><h2 class="text-primary">Nanette's Cake</h2></a><span class="splash-description">Please enter your admin account.</span></div>
            <div class="card-body">
